...
sudo cp /home/$USERNAME/sourceAFRICA/config/server/files/nginx/nginx.conf /etc/nginx/
sudo cp /home/$USERNAME/sourceAFRICA/config/server/files/nginx/documentcloud.conf /etc/nginx/
sudo cp /home/$USERNAME/sourceAFRICA/config/server/files/nginx/passenger.conf /etc/nginx/
sudo cp /home/$USERNAME/sourceAFRICA/config/server/files/nginx/staging.conf /etc/nginx/sites-available/
sudo cp /home/$USERNAME/sourceAFRICA/config/server/files/nginx/production.conf /etc/nginx/sites-available/
sudo cp /home/$USERNAME/sourceAFRICA/config/server/files/nginx/development.conf /etc/nginx/sites-available/
...
# touch -f /home/$USERNAME/sourceAFRICA/log/pixel_ping.pid
# touch -f /home/$USERNAME/sourceAFRICA/log/pixel_ping.log
...
echo "
function vrails() {
 sudo su -l ubuntu -c \"cd /home/ubuntu/sourceAFRICA && rails \$1 \$2 \$3\"
}
" >> /home/vagrant/.bashrc
...
echo "
function vrake() {
  sudo su -l ubuntu -c \"cd /home/ubuntu/sourceAFRICA && rake \$1 \$2 \$3\"
}
" >> /home/vagrant/.bashrc
...
echo "
function vbundle() {
 sudo su -l ubuntu -c \"cd /home/ubuntu/sourceAFRICA && bundle \$1 \$2 \$3\"
}
" >> /home/vagrant/.bashrc
