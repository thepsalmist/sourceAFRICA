...
cp /home/$USERNAME/sourceAFRICA/config/server/files/postgres/pg_hba.conf /etc/postgresql/9.4/main/pg_hba.conf
cp /etc/postgresql/9.4/main/postgresql.conf /etc/postgresql/9.4/main/postgresql.default.conf
cp /home/$USERNAME/sourceAFRICA/config/server/files/postgres/postgresql.conf /etc/postgresql/9.4/main/postgresql.conf
...
sudo su - $USERNAME -c "cd /home/$USERNAME/sourceAFRICA && rake db:migrate"
